...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private int totalWeight = 6;
    private int currentWeight = 6;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1) {
            ...
            if (titleCategoryInterface.isShowSuspension()) {
                if (position == 0) {
                    currentWeight = params.getSpanSize();
                    outRect.set(0, mTitleHeight, 0, 0);
                } else {//其他的通过判断
                    if (null != titleCategoryInterface.getSuspensionTag()) {
                        if (!titleCategoryInterface.getSuspensionTag().equals(mDatas.get(position - 1).getSuspensionTag())) {
                            currentWeight = params.getSpanSize();
                        }else {
                            currentWeight+=params.getSpanSize();
                        }
